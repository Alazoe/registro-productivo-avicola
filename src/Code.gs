...
// Versión base - aplica a todas las avícolas
...
// ------------------------------------------------------------
// OBTENER LOTES ACTIVOS desde hoja CONFIGURACIÓN
// Filas 10 a 14 (hasta 5 lotes)
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// GUARDAR DATOS PRODUCTIVOS DIARIOS
// ------------------------------------------------------------
function guardarDatos(datos) {
  try {
    ...
    // Encontrar siguiente fila vacía desde fila 9
    let ultimaFila = 9;
    ...
    // Validar que no exista ya esa fecha
    ...
    // Obtener % esperado desde hoja MAESTRO CURVAS
    ...
    fila.setValues([[
      fecha, edadSemanas, nAves, mortalidad, kgAlimento,
      nHuevos, sucios, rotos, trizados, sangre,
...
// ------------------------------------------------------------
// CALCULAR DATOS PARA EL SIGUIENTE DÍA
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// OBTENER CONFIGURACIÓN DEL PRODUCTOR
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// UTILIDAD: Generar objeto CURVAS desde hoja MAESTRO CURVAS
// (ejecutar manualmente para actualizar el JS del frontend)
// ------------------------------------------------------------
